...
def main() -> int:
    ...
    lines = [
        ...
        r"spread between published segmenters on these images. The unperturbed",
        r"query scores Top-1 $0.210$ against this attacker and the isotropic",
        r"control $0.197$ at the operating point. Retrieval is on MSLS and",
        r"utility on VOC, paired by budget, not by image.}",
